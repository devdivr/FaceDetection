...
static const double BORDER_FRAC = .0; // fraction of image width or height
    ...
    const Image& img)        // io
{
    ...
    __android_log_print(ANDROID_LOG_ERROR, "Selfiesta", "BORDER_FRAC %f, border %d x %d", BORDER_FRAC, leftborder, topborder);
